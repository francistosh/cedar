...
//        } else {
            $this->datatables
                ->select("id, date, reference_no,invoice_no, supplier, status, grand_total, paid, (grand_total-paid) as balance, payment_status")
                ->from('purchases');
       // }
                ...
                if ($this->input->post('form_action') == 'export_excel' || $this->input->post('form_action') == 'export_pdf') {
                    ...
                    foreach ($_POST['val'] as $id) {
                        ...
                        $this->excel->getActiveSheet()->SetCellValue('B' . $row, $purchase->reference_no);
                         $this->excel->getActiveSheet()->SetCellValue('C' . $row, $purchase->invoice_no);
