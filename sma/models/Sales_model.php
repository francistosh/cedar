...
class Sales_model extends CI_Model
{
    ...
    public function getProductNames($term, $warehouse_id, $limit = 30)
    {
        $this->db->select('products.id, code, name, type, warehouses_products.quantity, price, tax_rate, tax_method , cf1')
