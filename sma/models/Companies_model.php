    ...
    public function addPersonToErp($data){
        ...
        if($data['group_name']=="supplier"){
         ...
         $supplier['supplier_id']=$data['person_id'];
            $supplier['supp_name']=$data['company'];
                    $supplier['supp_ref']=$data['company'];
     ...
     unset($supplier);
          ...
          $customer['debtor_no']=$data['person_id'];
           $customer['name']=$data['company'];
                 $customer['debtor_ref']=$data['company'];
           ...
           //insert into customer branch
                   ...
                   $custbranch['br_name']=$data['company'];
                   $custbranch['branch_ref']=$data['company'];
