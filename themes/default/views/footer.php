...
<?= ($m == 'delivery' && ($v == 'add' || $v == 'edit')) ? '<script type="text/javascript" src="' . $assets . 'js/delivery.js"></script>' : ''; ?>
<?= ($m == 'deliveries' && ($v == 'add' || $v == 'edit')) ? '<script type="text/javascript" src="' . $assets . 'js/delivery.js"></script>' : ''; ?>
