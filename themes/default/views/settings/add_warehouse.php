<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="control-label" for="tilno"><?php echo $this->lang->line("Till_No"); ?></label>

                <div class="controls"> <?php echo form_input('tillno', '', 'class="form-control" id="tillno"'); ?> </div>
            </div>
            <div class="form-group">
