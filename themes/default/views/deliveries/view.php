<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-file"></i><?= lang("delivery_no") . '. ' . $inv->id; ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right" class="tasks-menus" role="menu" aria-labelledby="dLabel">
                        ...
                        <?php } ?>
                        <li><a href="<?= site_url('delivery/edit/' . $inv->id) ?>"><i
                                    class="fa fa-edit"></i> <?= lang('edit_delivery') ?></a></li>
                        <li><a href="<?= site_url('sales/add/' . $inv->id) ?>"><i
                                    class="fa fa-plus-circle"></i> <?= lang('create_invoice') ?></a></li>
                        <li><a href="<?= site_url('delivery/email/' . $inv->id) ?>" data-target="#myModal"
                               data-toggle="modal"><i class="fa fa-envelope-o"></i> <?= lang('send_email') ?></a></li>
                        <li><a href="<?= site_url('delivery/pdf/' . $inv->id) ?>"><i
                                    class="fa fa-file-pdf-o"></i> <?= lang('export_to_pdf') ?></a></li>
                        <!--<li><a href="<?= site_url('delivery/excel/' . $inv->id) ?>"><i class="fa fa-file-excel-o"></i> <?= lang('export_to_excel') ?></a></li>-->
                    </ul>
                </li>
            </ul>
        </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="col-xs-8 pull-right">
                    <div class="col-xs-12 text-right">
                        ...
                        <?php $this->sma->qrcode('link', urlencode(site_url('delivery/view/' . $inv->id)), 2); ?>
        ...
        <?php if (!$Supplier || !$Customer) { ?>
            <div class="buttons">
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <div class="btn-group"><a href="<?= site_url('delivery/pdf/' . $inv->id) ?>"
                                              class="tip btn btn-primary" title="<?= lang('download_pdf') ?>"><i
                                class="fa fa-download"></i> <span class="hidden-sm hidden-xs"><?= lang('pdf') ?></span></a>
                    </div>
                    <div class="btn-group"><a href="<?= site_url('delivery/email/' . $inv->id) ?>" data-toggle="modal"
                    ...
                    <div class="btn-group"><a href="<?= site_url('delivery/edit/' . $inv->id) ?>"
                    ...
                    <div class="btn-group"><a href="#" class="tip btn btn-danger bpo"
                                              title="<b><?= $this->lang->line("delete_delivery") ?></b>"
                                              data-content="<div style='width:150px;'><p><?= lang('r_u_sure') ?></p><a class='btn btn-danger' href='<?= site_url('delivery/delete/' . $inv->id) ?>'><?= lang('i_m_sure') ?></a> <button class='btn bpo-close'><?= lang('no') ?></button></div>"
