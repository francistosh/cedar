    ...
    $(document).ready(function () {
        ...
        $("#add_item").autocomplete({
            source: function (request, response) {
                ...
                $.ajax({
                    type: 'get',
                    url: '<?= site_url('delivery/suggestions'); ?>',
                    dataType: "json",
                    data: {
                        term: request.term,
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo form_open_multipart("delivery/add", $attrib)
                ?>
                ...
                <div class="row">
                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                foreach ($customers as $customer) {
                                                    $wh1[$customer->id] = $customer->name;
                                                }
                                                echo form_dropdown('customer', $wh1, (isset($_POST['customer']) ? $_POST['customer'] : ""), 'id="qucustomer" class="form-control input-tip select" data-placeholder="' . $this->lang->line("select") . ' ' . $this->lang->line("customer") . '" required="required" style="width:100%;" ');
                                                ?>
                        ...
                        <div class="col-sm-12">
                            <div
                                class="fprom-group"><?php echo form_submit('add_delivery', $this->lang->line("submit"), 'id="add_delivery" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
