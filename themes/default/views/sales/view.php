            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        if ($inv->bank_id != 0) { ?>
                        <div class="well well-sm">
                                <p class="bold"><?= lang("Bank_Details"); ?>:</p>

                                <div><b>Acct Name: </b> <?= $this->sma->decode_html($bank->acct_name); ?><br>
                                <b>Bank Name: </b><?= $this->sma->decode_html($bank->bank_name);?><br>
                                <b>Account No: </b><?= $this->sma->decode_html($bank->acct_no);?><br>
                                <b>Bank Code: </b><?= $this->sma->decode_html($bank->bank_code);?><br>
                                <b>Branch Code: </b><?= $this->sma->decode_html($bank->branch_code);?><br>
                                <b>Swift Code: </b><?= $this->sma->decode_html($bank->swift_code);?><br></div>
                            </div>
                           <?php } ?>  
                    </div>
