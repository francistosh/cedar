...
<div id="wrap">
    <div class="row">
        <div class="col-lg-12">
            ...
            <?php } ?>
            <div class="clearfix text-center bold"><center><span style="font-size:14px"><u>Invoice</u></span></center></div>
            ...
            <div class="row padding10">
                <div class="col-xs-5">
                   ...
                   // echo "</p>";
                    ...
                    echo "<br>".$warehouse->name."<br> Nairobi Kenya."
                    ?>
                    <div class="clearfix"></div>
                </div>
                <div class="col-xs-5">
            ...
            <div class="row padding10">
                ...
                <div class="col-xs-5">
                    <div class="bold">
                        ...
                        <img src="assets/uploads/qrcode<?= $this->session->userdata('user_id') ?>.png"
                             alt="<?= $inv->reference_no ?>" class="pull-right"/>
                        <?php $br = $this->sma->save_barcode($inv->reference_no, 'code39', 50, false); ?>
                        <img src="assets/uploads/barcode<?= $this->session->userdata('user_id') ?>.png"
            ...
            <div class="row">
                <div class="col-xs-6">
                    ...
                    if ($inv->bank_id != 0) { ?>
                    <div class="well well-sm">
                                <p class="bold"><u><?= lang("Bank_Details"); ?>:</u></p>

                                <div ><span class="bold">Acct Name: </span> <?= $this->sma->decode_html($bank->acct_name); ?><br>
                                <span class="bold">Bank Name: </span><?= $this->sma->decode_html($bank->bank_name);?><br>
                                <span class="bold">Account No: </span><?= $this->sma->decode_html($bank->acct_no);?><br>
                                <span class="bold">Bank Code: </span><?= $this->sma->decode_html($bank->bank_code);?><br>
                                <span class="bold">Branch Code: </span><?= $this->sma->decode_html($bank->branch_code);?><br>
                                <span class="bold">Swift Code: </span><?= $this->sma->decode_html($bank->swift_code);?><br></div>
                            </div>
                         <?php }   ?>
                </div>
     ...
     <p class="pull-left bold"><i><?= "*This is a computer generated sales invoice which does not require any authorized signature*"; ?></i></p>
</div>
</body>
</html>