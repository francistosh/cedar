                        ...
                        <div class="col-md-12" id="sticker">
                            <div class="well well-sm">
                                <div class="form-group" style="margin-bottom:0;">
                                  ...
                                  <div class="input-group-addon no-print" style="padding: 2px 5px;"><a
                                                        href="<?= site_url('customers/pradd'); ?>" id="add-customer"
                                                        class="external" data-toggle="modal" data-target="#myModal"><i
                                                            class="fa fa-2x fa-plus-circle" id="addIcon"></i></a></div>
                                        <div class="input-group-addon" style="padding-left: 10px; padding-right: 10px;">
                                ...
                                <?= lang("Bank", "bank"); ?>
                                 <?php
                                                ...
                                                foreach ($banks as $bank) {
                                                    $bk[$bank->id] = $bank->bank_name;
                                                }
                                                
                                                echo form_dropdown('slbnk', $bk, (isset($_POST['slbnk']) ? $_POST['slbnk'] : ''), 'id="slbnk" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("Bank") . '" required="required" style="width:100%;" ');
                                                ?>
