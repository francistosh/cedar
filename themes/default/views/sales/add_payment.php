            ...
            <div id="payments">
                ...
                <div class="well well-sm well_1">
                    <div class="col-md-12">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <select name="paid_by" id="paid_by_1" class="form-control paid_by"
                                        ...
                                        <option value="creditnote"><?= lang("On_Credit"); ?></option>
                        ...
                        <div class="pcreditnote_1" style="display:none;">
                            <div class="form-group"><?= lang("Credit_Note_Details", "crdnt_det_1"); ?>
                                <input name="crdnt_det" type="text" id="crdnt_det" class="form-control crdnt_det"/>
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
