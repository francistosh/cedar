                            ...
                            <div class="form-group">
                                <?= lang("Bank", "bank"); ?>
                                 <?php
                                                ...
                                                echo form_dropdown('bnk', $bk, (isset($_POST['bnk']) ? $_POST['bnk'] : $inv->bank_id), 'id="bnk" class="form-control input-tip select" data-placeholder="' . lang("select") . ' ' . lang("Bank") . '" required="required" style="width:100%;" ');
                                                ?>
