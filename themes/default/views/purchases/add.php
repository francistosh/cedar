            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <?= lang("Invoice_no", "poref"); ?>
                                <?php echo form_input('invoice_no', (isset($_POST['invoice_no']) ? $_POST['invoice_no'] : $purchase->invoice_no), 'class="form-control input-tip" id="poref" required="required"'); ?>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <?= lang("payment_status", "purpayment_status"); ?>
                                <?php $pst = array('pending' => lang('pending'), 'due' => lang('due'), 'partial' => lang('partial'), 'paid' => lang('paid'));
                                echo form_dropdown('payment_status', $pst, '', 'class="form-control input-tip" required="required" id="purpayment_status"'); ?>
...
<script type="text/javascript">
    $(document).ready(function () {
        	$(document).on('change', '#purpayment_status', function (e) {
alert ("Test");
 if ($("#purpayment_status").val()=="partial"){
document.getElementById("payments").style.display = "block";

}
else if($("#purpayment_status").val()=="paid"){
document.getElementById("payments").style.display = "block";
}
else{
