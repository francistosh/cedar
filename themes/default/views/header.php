                    ...
                    <?php    }
						...
						<?php } ?>
                            ...
                            <li class="mm_quotes">
                             ...
                             <li class="mm_delivery" >
                                <a class="dropmenu" href="#"><i class="fa fa-heart-o"></i><span
                                        class="text"> <?= lang('deliveries'); ?> </span> <span
                                        class="chevron closed"></span></a>
                                <ul>

                                    <li id="delivery_index"><a class="submenu" href="<?= site_url('delivery'); ?>"><i
                                                class="fa fa-heart-o"></i><span
                                                class="text"> <?= lang('list_deliveries'); ?></span></a></li>
                                    <li id="delivery_add"><a class="submenu" href="<?= site_url('delivery/add'); ?>"><i
                                                class="fa fa-plus-circle"></i><span
                                                class="text"> <?= lang('add_deliveries'); ?></span></a></li>
                                </ul>
                            </li>
						...
						<?php } ?>
                            ...
                            <li class="mm_reports">
                                ...
                                <li id="reports_stock_sheet"><a
                                            href="<?= site_url('reports/stock_evaluation') ?>"><i
                                                class="fa fa-bar-chart-o"></i><span
                                                class="text"> <?= lang('Stock_Evaluation_Report'); ?></span></a></li>
                        ...
                        <?php
                            ...
                            <?php if ($GP['quotes-index']) { ?>
                                <li class="mm_delivery">
                                    <a class="dropmenu" href="#"><i class="fa fa-heart-o"></i><span
                                            class="text"> <?= lang('deliverys'); ?> </span> <span
                                            class="chevron closed"></span></a>
                                    <ul>
                                        <li id="sales_index"><a class="submenu" href="<?= site_url('delivery'); ?>"><i
                                                    class="fa fa-heart-o"></i><span
                                                    class="text"> <?= lang('list_deliverys'); ?></span></a></li>
                                        <?php if ($GP['quotes-add']) { ?>
                                            <li id="sales_add"><a class="submenu" href="<?= site_url('delivery/add'); ?>"><i
                                                        class="fa fa-plus-circle"></i><span
                                                        class="text"> <?= lang('add_quote'); ?></span></a></li>
                                        <?php } ?>
                                    </ul>
