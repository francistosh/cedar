        ...
        oTable = $('#PRData').dataTable({
            ...
            "aoColumns": [
                {"bSortable": false, "mRender": checkbox}, {
                    "bSortable": false,
                    "mRender": img_hl
                }, null, null, null, <?php echo '{"mRender": currencyFormat}, {"mRender": currencyFormat},'; ?> {"mRender": currencyFormat},{"mRender": decimalFormat}, { "bSearchable": false,}, <?php if(!$warehouse_id || !$Settings->racks) { echo '{"bVisible": false},'; } else { echo '{"bSortable": true},'; } ?> {"mRender": decimalFormat}, {"bSortable": false}
            ]
            ...
            ?>
             {column_number: <?php $col++; echo $col; ?>, filter_default_label: "[<?=lang('Best_Price');?>]", filter_type: "text", data: []},
