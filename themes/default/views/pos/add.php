                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control kb-pad" id="pprice">
					                    ...
					                    <div class="form-group">
                        <label for="bstrice" class="col-sm-4 control-label"><?= lang('Best_price') ?></label>

                        <div class="col-sm-8">
                            <input type="text" class="form-control kb-pad" id="bstprice" readonly="true">
                        </div>
                    </div>
