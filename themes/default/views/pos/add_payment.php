            ...
            <div id="payments">
                ...
                <div class="well well-sm well_1">
                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="paid_by" id="paid_by_1" class="form-control paid_by"
                                     ...
                                     <!--   <option value="CC"><?= lang("CC"); ?></option> -->
										 ...
										 <option value="bankslip"><?= lang("Bank_Slip"); ?></option>
						...
						<div class="bnkslip_1" style="display:none;">
                            <div class="form-group"><?= lang("Bank_Slip_No", "bnkslip_no"); ?>
                                <input name="bnkslip_no" type="text" id="bnkslip_no" class="form-control bnkslip_no"/>
                            </div>
                        </div>
